...
public class Constants {
    ...
    public static String getSearchLinesUrl(String keyword) {
        return BASE_SERVER + CITY_ID + "/search.do?keyword=" + keyword + "&type=line";
    }
    ...
    public static String getLineDetailByLineNo(String lineNo, int direction) {
        return BASE_SERVER + CITY_ID + "/line/" + lineNo + SPLITE + direction + END_STR;
    }
    ...
    public static String getLineDetailByLineId(String lineId) {
        return BASE_SERVER + CITY_ID + "/line/" + lineId + END_STR;
    }
    ...
    public static String getNearbyLines(double longitude, double latitude) {
        return BASE_SERVER + CITY_ID + "/nearby/lines/" + longitude + SPLITE + latitude + END_STR;
    }
    ...
    public static String getStopIdByName(String stopName) {
        return BASE_SERVER + CITY_ID + "/search.do?keyword=" + stopName + "&type=stop";
    }
    ...
    public static String getStopGroupByStopId(String stopId) {
        return BASE_SERVER + CITY_ID + "/stop/group/" + stopId + END_STR;
    }
